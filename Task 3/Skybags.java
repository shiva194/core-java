class Skybags {
	...
	static String manufacturer="VIP Industries Ltd";
    static String asin ="B08Z21W4TG";
    static String itemModelNumber="BPBRATESGN";
    static String countryOfOrigin="Bangladesh";
    static String department="unisex-adult";
	static String itemWeight="350 g";
	public static void main(String Bags[]) {
	
	String manufacturer="VIP Industries Ltd";
    String asin ="B08Z21W4TG";
    String itemModelNumber="BPBRATESGN";
    String countryOfOrigin="Bangladesh";
    String department="unisex-adult";
	String itemWeight="350 g";
